/*
 * $Id: resall.c,v 1.19 2002/02/28 10:54:44 spoel Exp $
 * 
 ...
 */
static char *SRCID_resall_c = "$Id: resall.c,v 1.19 2002/02/28 10:54:44 spoel Exp $";
#include "sysstuff.h"
#include <ctype.h>
#include "assert.h"
#include "string2.h"
