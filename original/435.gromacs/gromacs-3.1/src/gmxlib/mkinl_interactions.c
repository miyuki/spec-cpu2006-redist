/*
 * $Id: mkinl_interactions.c,v 1.17 2002/02/28 10:49:28 spoel Exp $
 * 
 ...
 */
static char *SRCID_mkinl_interactions_c = "$Id: mkinl_interactions.c,v 1.17 2002/02/28 10:49:28 spoel Exp $";
#include "mkinl.h"
#include <string.h>
