/*
 * $Id: mkinl_declarations.c,v 1.18 2002/02/28 10:49:27 spoel Exp $
 * 
 ...
 */
static char *SRCID_mkinl_declarations_c = "$Id: mkinl_declarations.c,v 1.18 2002/02/28 10:49:27 spoel Exp $";
#include "mkinl.h"
#include <string.h>
