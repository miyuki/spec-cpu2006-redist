...
#
# $Id: compare_module_file.perl,v 1.2.2.3 2003/10/06 14:13:50 dylan Exp $
#
#*******************************************************************************
...
# version 7.  For version 08.00.00 if their module file format, ignore the last
# record of the file, where the record separator is chr(0).
  my $lastreclength = 0;
  open(FILE1,$file1) or die "Cannot open $file1\n";
  binmode(FILE1);
  local $/ = chr(0);
