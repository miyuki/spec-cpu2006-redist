...
int CCTK_FCALL einstein_registerslicing__(ONE_FORTSTRING_ARG);
int CCTK_FCALL einstein_getslicinghandle__(ONE_FORTSTRING_ARG);
void Einstein_ActivateSlicing(cGH *GH) ;

static const char *rcsid = "$Header: /cactus/CactusEinstein/Einstein/src/Attic/Slicing.c,v 1.25 2002/01/05 18:58:18 allen Exp $";
