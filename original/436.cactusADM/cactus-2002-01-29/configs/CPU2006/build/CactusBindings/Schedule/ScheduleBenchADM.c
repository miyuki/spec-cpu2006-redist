...
extern int bench_preloop__(void); /* Note that this is a cheat, we just need a function pointer. */
extern int bench_staggeredleapfrog1a_ts__(void); /* Note that this is a cheat, we just need a function pointer. */
extern int bench_staggeredleapfrog1a__(void); /* Note that this is a cheat, we just need a function pointer. */
extern int bench_staggeredleapfrog2__(void); /* Note that this is a cheat, we just need a function pointer. */
...

{
  ...
  CCTKi_ScheduleFunction((void *)bench_preloop__,
                        "Bench_PreLoop",
                        "BenchADM",
                        "benchadm",
                        "Setup for ADM",
  ...
  CCTKi_ScheduleFunction((void *)bench_staggeredleapfrog1a_ts__,
  ...
  CCTKi_ScheduleFunction((void *)bench_staggeredleapfrog1a__,
  ...
  CCTKi_ScheduleFunction((void *)bench_staggeredleapfrog2__,
