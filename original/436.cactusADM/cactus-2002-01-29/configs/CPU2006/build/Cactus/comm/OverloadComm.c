...
int CCTK_FCALL cctk_nprocs__ (const cGH *GH);
int CCTK_FCALL cctk_myproc__ (const cGH *GH);
void CCTK_FCALL cctk_barrier__ (int *ierror, const cGH *GH);
void CCTK_FCALL cctk_exit__ (int *ierror, cGH *GH, const int *retval);
void CCTK_FCALL cctk_abort__ (int *ierror, cGH *GH, const int *retval);
void CCTK_FCALL cctk_syncgroup__ (int *ierror, cGH *GH, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_enablegroupcomm__ (int *ierror, cGH *GH, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_disablegroupcomm__ (int *ierror, cGH *GH, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_enablegroupstorage__ (int *ierror, cGH *GH, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_disablegroupstorage__ (int *ierror, cGH *GH, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_querygroupstorage__ (int *ierror, const cGH *GH, ONE_FORTSTRING_ARG);
