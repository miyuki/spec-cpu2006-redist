 ...
 ********************************************************************/
void CCTK_FCALL cctk_numtimers__
                           (int *ierr);
void CCTK_FCALL cctk_numclocks__
                           (int *ierr);
void CCTK_FCALL cctk_timercreate__
                           (int *timer_index, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_timercreatei__
                           (int *ierr);
void CCTK_FCALL cctk_timerdestroy__
                           (int *ierr, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_timerdestroyi__
                           (int *ierr, int *this_timer);
void CCTK_FCALL cctk_timerstart__
                           (int *ierr, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_timerstarti__
                           (int *ierr, int *this_timer);
void CCTK_FCALL cctk_timerstop__
                           (int *ierr, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_timerstopi__
                           (int *ierr, int *this_timer);
void CCTK_FCALL cctk_timerreset__
                           (int *ierr, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_timerreseti__
                           (int *ierr, int *this_timer);
void CCTK_FCALL cctk_timerprintdatai__
                           (int *ierr, int *this_timer, int *this_clock);
void CCTK_FCALL cctk_timerprintdata__
