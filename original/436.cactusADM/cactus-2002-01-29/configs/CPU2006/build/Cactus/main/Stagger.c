 ...
 *********************     Fortran Wrappers   ***********************
 ********************************************************************/
void CCTK_FCALL cctk_groupstaggerindexgi__
                           (int *stagcode, int *gindex);
void CCTK_FCALL cctk_groupstaggerindexgn__
                           (int *scode, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_staggerindex__
                           (int *scode, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_staggerdirindex__
                           (int *dsi, int *dir, int *gsi);
void CCTK_FCALL cctk_groupstaggerdirarray__
                           (int *ierr, int *dindex, int *dim, int *gsc);
void CCTK_FCALL cctk_groupstaggerdirarraygi__
                           (int *ierr, int *dindex, int *dim, int *gi);
void CCTK_FCALL cctk_staggerdirname__
