 ...
 *********************     Fortran Wrappers    **********************
 ********************************************************************/
void CCTK_FCALL cctki_coordregistersystem__
                           (int *ierr, const int *dim, TWO_FORTSTRING_ARG);
void CCTK_FCALL cctk_coordregisterdata__
                           (int *handle,const int *dir,THREE_FORTSTRING_ARG);
void CCTK_FCALL cctk_coordregisterrange__
                           (int *ierr,
                            cGH *GH,
                            ...
                            const int *dir,
                            TWO_FORTSTRING_ARG);
void CCTK_FCALL cctk_coordregisterrangephysindex__
                           (int *ierr,
                            cGH *GH,
                            const int *lower,
                            const int *upper,
                            const int *dir,
                            TWO_FORTSTRING_ARG);
void CCTK_FCALL cctk_coordsystemhandle__
                           (int *ierr, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_coordindex__
                           (int *vindex, const int *dir, TWO_FORTSTRING_ARG);
void CCTK_FCALL cctk_coordsystemdim__
                           (int *dim, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_coorddir__
                           (int *dir, TWO_FORTSTRING_ARG);
void CCTK_FCALL cctk_coordrange__
                           (int *ierr,
                            const cGH *GH,
                            CCTK_REAL *lower,
                            CCTK_REAL *upper,
                            const int *dir,
                            TWO_FORTSTRING_ARG);
void CCTK_FCALL cctk_coordrangephysindex__
                           (int *ierr,
                            const cGH *GH,
                            int *lower,
                            int *upper,
                            const int *dir,
                            TWO_FORTSTRING_ARG);
void CCTK_FCALL cctk_coordlocalrange__
                           (int *ierr,
                            const cGH *GH,
                            CCTK_REAL *lower,
                            CCTK_REAL *upper,
