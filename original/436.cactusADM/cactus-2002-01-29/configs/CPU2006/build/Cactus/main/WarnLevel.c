...
void CCTK_FCALL cctk_info__
                           (TWO_FORTSTRING_ARG);
void CCTK_FCALL cctk_warn__
                           (const int *level,
                            const int *line,
                            THREE_FORTSTRING_ARG);
void CCTK_FCALL cctk_paramwarn__
                           (TWO_FORTSTRING_ARG);
int CCTK_FCALL cctk_messageformat__
                          (ONE_FORTSTRING_ARG);
void CCTK_FCALL cctki_expecterror__
                           (const int *in,
                            const int *err,
                            const int *warnonerr,
                            const int *line,
                            THREE_FORTSTRING_ARG);
void CCTK_FCALL cctki_expectok__
                           (const int *in,
                            const int *ok,
                            const int *warnonerr,
                            const int *line,
                            THREE_FORTSTRING_ARG);
void CCTK_FCALL cctki_notyetimplemented__
                           (ONE_FORTSTRING_ARG);
