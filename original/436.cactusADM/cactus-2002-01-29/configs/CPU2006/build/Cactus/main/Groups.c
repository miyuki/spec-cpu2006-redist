...
void CCTK_FCALL cctk_groupindex__
                           (int *vindex,
                            ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_varindex__
                           (int *vindex,
                            ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_maxdim__
                           (int *dim);
void CCTK_FCALL cctk_numvars__
                           (int *num_vars);
void CCTK_FCALL cctk_numgroups__
                           (int *num_groups);
void CCTK_FCALL cctk_groupindexfromvari__
                           (int *gindex,
                            const int *var);
void CCTK_FCALL cctk_groupindexfromvar__
                           (int *vindex,
                            ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_grouptypenumber__
                           (int *number,
                            ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_vartypenumber__
                           (int *number,
                            ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_groupscopenumber__
                           (int *number,
                            ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_groupdistribnumber__
                           (int *number,
                            ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_firstvarindexi__
                           (int *first,
                            const int *group);
void CCTK_FCALL cctk_numvarsingroup__
                           (int *num,
                            ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_vartypei__
                           (int *type,
                            const int *var);
void CCTK_FCALL cctk_numtimelevelsfromvari__
                           (int *num,
                            const int *var);
void CCTK_FCALL cctk_numtimelevelsfromvar__
                           (int *num,
                            ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_printgroup__
                           (const int *group);
void CCTK_FCALL cctk_printvar__
                           (const int *var);
void CCTK_FCALL cctk_groupdimi__
                           (int *dim,
                            const int *group);
void CCTK_FCALL cctk_groupdimfromvari__
                           (int *dim,
                            const int *vi);
