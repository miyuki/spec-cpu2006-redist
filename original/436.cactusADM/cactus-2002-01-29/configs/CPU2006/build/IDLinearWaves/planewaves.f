      subroutine planewaves(cctk_dim, cctk_gsh, cctk_lsh, cctk_lbnd, cct
     &k_ubnd, cctk_lssh, cctk_from, cctk_to, cctk_bbox, cctk_delta_time,
     & cctk_time, cctk_delta_space, cctk_origin_space, cctk_levfac, cctk
     &_convlevel, cctk_nghostzones, cctk_iteration, cctkGH,Xconfac0,Xcon
     &fac1,Xconfac2,Xconfac_1derivs0,Xconfac_1derivs1,Xconfac_1derivs2,X
     &confac_2derivs0,Xconfac_2derivs1,Xconfac_2derivs2,Xcoordinates0,Xc
     &oordinates1,Xcoordinates2,Xcurv0,Xcurv1,Xcurv2,Xlapse0,Xlapse1,Xla
     &pse2,Xmask0,Xmask1,Xmask2,Xmetric0,Xmetric1,Xmetric2,Xshift0,Xshif
     &t1,Xshift2,active_slicing_handle,alp,betax,betay,betaz,coarse_dx,c
     &oarse_dy,coarse_dz,conformal_state,courant_min_time,courant_wave_s
     &peed,emask,gxx,gxy,gxz,gyy,gyz,gzz,kxx,kxy,kxz,kyy,kyz,kzz,psi,psi
     &x,psixx,psixy,psixz,psiy,psiyy,psiyz,psiz,psizz,r,shift_state,x,y,
     &z)
      implicit none
      INTEGER cctk_dim
