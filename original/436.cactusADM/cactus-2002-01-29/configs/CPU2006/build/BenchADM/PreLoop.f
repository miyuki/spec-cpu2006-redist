     ...
     &cctk_ubnd, cctk_lssh, cctk_from, cctk_to, cctk_bbox, cctk_delta_ti
     &me, cctk_time, cctk_delta_space, cctk_origin_space, cctk_levfac, c
     &ctk_convlevel, cctk_nghostzones, cctk_iteration, cctkGH,XADM_curv_
     &stag0,XADM_curv_stag1,XADM_curv_stag2,XADM_metric_prev0,XADM_metri
     &c_prev1,XADM_metric_prev2,XADM_sources0,XADM_sources1,XADM_sources
     &2,ADM_gxx,ADM_gxx_p,ADM_gxy,ADM_gxy_p,ADM_gxz,ADM_gxz_p,ADM_gyy,AD
     &M_gyy_p,ADM_gyz,ADM_gyz_p,ADM_gzz,ADM_gzz_p,ADM_kxx_stag,ADM_kxx_s
     &tag_p,ADM_kxx_stag_p_p,ADM_kxy_stag,ADM_kxy_stag_p,ADM_kxy_stag_p_
     &p,ADM_kxz_stag,ADM_kxz_stag_p,ADM_kxz_stag_p_p,ADM_kyy_stag,ADM_ky
     &y_stag_p,ADM_kyy_stag_p_p,ADM_kyz_stag,ADM_kyz_stag_p,ADM_kyz_stag
     &_p_p,ADM_kzz_stag,ADM_kzz_stag_p,ADM_kzz_stag_p_p,adms_gxx,adms_gx
     &y,adms_gxz,adms_gyy,adms_gyz,adms_gzz,adms_kxx,adms_kxy,adms_kxz,a
     &dms_kyy,adms_kyz,adms_kzz,Xconfac0,Xconfac1,Xconfac2,Xconfac_1deri
     &vs0,Xconfac_1derivs1,Xconfac_1derivs2,Xconfac_2derivs0,Xconfac_2de
     &rivs1,Xconfac_2derivs2,Xcoordinates0,Xcoordinates1,Xcoordinates2,X
     &curv0,Xcurv1,Xcurv2,Xlapse0,Xlapse1,Xlapse2,Xmask0,Xmask1,Xmask2,X
     &metric0,Xmetric1,Xmetric2,Xshift0,Xshift1,Xshift2,active_slicing_h
     &andle,alp,betax,betay,betaz,coarse_dx,coarse_dy,coarse_dz,conforma
     &l_state,courant_min_time,courant_wave_speed,emask,gxx,gxy,gxz,gyy,
     &gyz,gzz,kxx,kxy,kxz,kyy,kyz,kzz,psi,psix,psixx,psixy,psixz,psiy,ps
     &iyy,psiyz,psiz,psizz,r,shift_state,x,y,z)
      implicit none
      INTEGER cctk_dim
     ...
     &")) then
         call CCTK_Info("BenchADM",("Geodesic slicing (lapse set to unit
     &y)"))
         call CCTK_Info("BenchADM",("  lapse will not be evolved in ADM 
     &routines"))
      else
         call CCTK_Warn(1,74,"PreLoop.F","BenchADM","WARNING slicing reg
     &istered but not coded!")
      end if
      return
      end
