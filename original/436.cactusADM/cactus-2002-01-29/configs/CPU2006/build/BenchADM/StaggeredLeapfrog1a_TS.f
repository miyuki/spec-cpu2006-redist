      subroutine Bench_StaggeredLeapfrog1a_TS(cctk_dim, cctk_gsh, cctk_l
     &sh, cctk_lbnd, cctk_ubnd, cctk_lssh, cctk_from, cctk_to, cctk_bbox
     &, cctk_delta_time, cctk_time, cctk_delta_space, cctk_origin_space,
     & cctk_levfac, cctk_convlevel, cctk_nghostzones, cctk_iteration, cc
     &tkGH,XADM_curv_stag0,XADM_curv_stag1,XADM_curv_stag2,XADM_metric_p
     &rev0,XADM_metric_prev1,XADM_metric_prev2,XADM_sources0,XADM_source
     &s1,XADM_sources2,ADM_gxx,ADM_gxx_p,ADM_gxy,ADM_gxy_p,ADM_gxz,ADM_g
     &xz_p,ADM_gyy,ADM_gyy_p,ADM_gyz,ADM_gyz_p,ADM_gzz,ADM_gzz_p,ADM_kxx
     &_stag,ADM_kxx_stag_p,ADM_kxx_stag_p_p,ADM_kxy_stag,ADM_kxy_stag_p,
     &ADM_kxy_stag_p_p,ADM_kxz_stag,ADM_kxz_stag_p,ADM_kxz_stag_p_p,ADM_
     &kyy_stag,ADM_kyy_stag_p,ADM_kyy_stag_p_p,ADM_kyz_stag,ADM_kyz_stag
     &_p,ADM_kyz_stag_p_p,ADM_kzz_stag,ADM_kzz_stag_p,ADM_kzz_stag_p_p,a
     &dms_gxx,adms_gxy,adms_gxz,adms_gyy,adms_gyz,adms_gzz,adms_kxx,adms
     &_kxy,adms_kxz,adms_kyy,adms_kyz,adms_kzz,Xconfac0,Xconfac1,Xconfac
     &2,Xconfac_1derivs0,Xconfac_1derivs1,Xconfac_1derivs2,Xconfac_2deri
     &vs0,Xconfac_2derivs1,Xconfac_2derivs2,Xcoordinates0,Xcoordinates1,
     &Xcoordinates2,Xcurv0,Xcurv1,Xcurv2,Xlapse0,Xlapse1,Xlapse2,Xmask0,
     &Xmask1,Xmask2,Xmetric0,Xmetric1,Xmetric2,Xshift0,Xshift1,Xshift2,a
     &ctive_slicing_handle,alp,betax,betay,betaz,coarse_dx,coarse_dy,coa
     &rse_dz,conformal_state,courant_min_time,courant_wave_speed,emask,g
     &xx,gxy,gxz,gyy,gyz,gzz,kxx,kxy,kxz,kyy,kyz,kzz,psi,psix,psixx,psix
     &y,psixz,psiy,psiyy,psiyz,psiz,psizz,r,shift_state,x,y,z)
      implicit none
      INTEGER cctk_dim
