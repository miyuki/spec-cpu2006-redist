...
{   my $meth = '_add_to_includepath';
    ...
    my $p5lib   = $ENV{SPECPERLLIB} || '';
    my $inc     = "@INC";         
    ok( $cb->$meth( directories => [$$] ),    
                                "   CB->$meth( $$ )" );
    
    my $new_p5lib   = $ENV{SPECPERLLIB};
    my $new_inc     = "@INC";    
    isnt( $p5lib, $new_p5lib,   "       SPECPERLLIB is now: $new_p5lib" );
    ...
    is( $new_p5lib, $ENV{SPECPERLLIB},
                                "           SPECPERLLIB unchanged" );
}    
