...
in C<%Config::Config>, and what the value is of the SPECPERLLIB environment variable.
...
from C<@INC>.
    ...
    use Config;
    my @dirs = split(/\Q$Config{path_sep}\E/, $ENV{SPECPERLLIB});
...
This should only be necessary if C</my/lib/path> is not in SPECPERLLIB.
