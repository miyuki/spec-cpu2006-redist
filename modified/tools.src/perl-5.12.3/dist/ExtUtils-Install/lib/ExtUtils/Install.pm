...
or C<$ENV{SPECPERLLIB}> or other standard locations, and C<$pattern> is the pattern that
...
sub inc_uninstall {
    ...
    my @PERL_ENV_LIB = split $Config{path_sep}, defined $ENV{'SPECPERLLIB'}
      ? $ENV{'SPECPERLLIB'} : $ENV{'PERLLIB'} || '';
