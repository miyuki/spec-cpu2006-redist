...
GCCHELPERDLL	*= $(CCHOME)\bin\libgcc_s_dw2-1.dll $(CCHOME)\bin\libstdc++-6.dll
...
.IF "$(CCTYPE)" == "GCC"
.IF "$(GCC_4XX)" == "define"
	$(foreach,i,$(GCCHELPERDLL) $(XCOPY) $i $(INST_BIN)\*.* & )
.ENDIF
.ENDIF
...
.IF "$(CCTYPE)" == "GCC"
.IF "$(GCC_4XX)" == "define"
	$(foreach,i,$(GCCHELPERDLL) $(XCOPY) $i ..\t\$(NULL) & )
.ENDIF
.ENDIF
