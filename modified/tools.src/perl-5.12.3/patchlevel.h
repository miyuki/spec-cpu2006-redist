...
static const char * const local_patches[] = {
	...
	PERL_GIT_UNPUSHED_COMMITS    	/* do not remove this line */
 	,"SPEC00 - Rename Benchmark module to PerlBenchmark"
 	,"SPEC01 - Remove non-Western-language support"
 	,"SPEC02 - Use SPEC-specific option and library environment variables"
	,NULL
};
