/* squidconf.h.  Generated by configure.  */
/* @configure_input@ */
/*****************************************************************
...
#ifdef SPEC_CPU
/* suppress a little bit of non ANSI code for SPEC_CPU */
#define SRE_STRICT_ANSI
#endif

/*
 * All porting issues for SPEC CPU had to do with being able to handle
 * large files needing 64 bit offsets.
 *
 * Because we do not need any such large files, the defines to allow
 * handling the large files was removed October 27, 2005 - alm
 *
 * See the bottom of this file for the undefines that removes the 
 * generation of code for 64bit file access
 *
 * The defines nolonger required are:
 * SPEC_CPU_HAVE_LFS64_FUNCS
 * SPEC_CPU_NO_LFS64_FUNCS
 * SPEC_CPU_RELIANT_MIPS
 * SPEC_CPU_MACOSX
 * SPEC_CPU_HPUX
 * SPEC_CPU_C99
 *
...
#endif
#if defined(SPEC_CPU)
/* After all of this - we do not need 64 bit offsets for the SPEC_CPU workloads
 * so do not define these for anyone (This was originally SPEC_CPU_WINDOWS)
*/
#undef HAVE_FTELLO
#undef HAVE_FSEEKO
#undef HAVE_FTELLO64
