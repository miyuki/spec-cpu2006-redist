...
#if defined (SPEC_CPU_SOLARIS) || defined (SPEC_CPU_HPUX) || \
    defined (SPEC_CPU_IRIX) || defined(SPEC_CPU_NEED_ALLOCA_H)
#include <alloca.h>
#endif
...
/* supply a qsort where SPEC's exact output requires it MJP & Alexey (Correct code semantics doesn't need this) */
extern void specqsort PARAMS ((PTR, int, int, int (*)() ));
...
/* Drastically simplified alloca configurator.  If we're using GCC,
   ...
   to call alloca(0).  */
/* Modified by MJP 19th April 2004 to minimize the logic */
