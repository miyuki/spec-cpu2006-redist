...
#ifndef SPEC_CPU
/* C99 does not allow the use of the STATIC block_aux_obstack
   in an externally scoped inlined routine                   */
inline
#endif
void
...
#ifdef SPEC_CPU
/* C99 does not allow the use of the STATIC edge_aux_obstack
   in an externally scoped inlined routine                  */
static
#endif
inline void
