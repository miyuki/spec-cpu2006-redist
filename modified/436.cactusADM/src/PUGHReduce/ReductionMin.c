...
# define THORN_IS_PUGHReduce
 ...
 /*@@
   ...
   @enddesc 
   @version $Header: /cactus/CactusPUGH/PUGHReduce/src/ReductionMin.c,v 1.6 2001/11/05 15:04:13 tradke Exp $
 @@*/
...
static const char *rcsid = "$Id: ReductionMin.c,v 1.6 2001/11/05 15:04:13 tradke Exp $";
