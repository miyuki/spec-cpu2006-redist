 ...
 /*@@
   ...
   @desc 
              ...
              of an arbitrary array which is defined as:
                  norm1 = $\Sigma |a_i| / np$
   @enddesc 
   @version $Header: /cactus/CactusPUGH/PUGHReduce/src/ReductionNorm1.c,v 1.4 2001/05/14 17:06:20 tradke Exp $
 @@*/
...
static const char *rcsid = "$Id: ReductionNorm1.c,v 1.4 2001/05/14 17:06:20 tradke Exp $";
